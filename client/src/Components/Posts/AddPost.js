...
const AddPost = () => {
  ...
  const navigate = useNavigate()
    ...
    const handleAdd=(a)=>{
    a.preventDefault()
    dispatch(addPost({title,description,category,marque,model,puissanceF,carburant,year,boite,kilometrage,gouvernorat,delegation,price,phone,image,carrosserie, owner:user._id, valid:false},navigate))
    ...
    switch (step) {
          ...
          <div sticky="0">
            ...
            <h3 className='headerTextForm'>Infos générales (obligatoires)</h3>
                ...
                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                    ...
                    <Form.Control onChange={(e)=>setTitle(e.target.value)}  type="text" placeholder="Entrer le titre" style={FormStyle} className='custom-input'/>
                </Form.Group>

                <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                  <Form.Label className='custom-label'>Description de l'annonce</Form.Label>
                  <Form.Control onChange={(e)=>setDescription(e.target.value)}  as="textarea" placeholder="Décrire votre annonce" rows={3} className="custom-input" style={FormStyle2}  />
                </Form.Group>
      ...
      <>
                ...
                <InputGroup className="mb-3">
                  <Form.Control onChange={(e)=>setPrice(e.target.value)}  type="number" style={FormStyleP}  placeholder="Entrez le prix en dinars tunisien" className="custom-input" aria-label="Amount (to the nearest dollar)" />
      ...
      case 2:
        return (
          ...
          <h3 className='headerTextForm'>Critères (obligatoires)</h3>
              ...
              <Form.Select onChange={(e)=>setMarque(e.target.value)} aria-label="Default select example"  style={FormStyle} className="custom-input" >
              ...
              <Form.Select onChange={(e)=>setModel(e.target.value)} aria-label="Default select example"  style={FormStyle} className="custom-input" >
              ...
              <InputGroup className="custom-input">
                  <Form.Control onChange={(e)=>setKilometrage(e.target.value)} type="number" style={FormStyle}  placeholder="Kilométrage" className="custom-input" aria-label="Amount (to the nearest dollar)" />
                </InputGroup>

                <Form.Label className='custom-label'></Form.Label>
              <InputGroup className="custom-input">
                  <Form.Control onChange={(e)=>setYear(e.target.value)} type="number" style={FormStyle}  placeholder="Année" className="custom-input" aria-label="Amount (to the nearest dollar)" />
                </InputGroup>
              ...
              <div className='d-flex justify-content-between my-4'>
              <Form.Select onChange={(e)=>setPuissanceF(e.target.value)} aria-label="Default select example"  style={FormStyle} className="" >
              ...
              <Form.Label className='custom-label'></Form.Label>
              <Form.Select onChange={(e)=>setBoite(e.target.value)} className='custom-input' aria-label="Default select example"  style={FormStyle} >
                  <option>Boite </option>
              ...
              <div className='d-flex justify-content-between my-4'>
              <Form.Select onChange={(e)=>setCarrosserie(e.target.value)} aria-label="Default select example"  style={FormStyle} className="" >
              ...
              <Form.Label className='custom-label'></Form.Label>
              <Form.Select onChange={(e)=>setCarburant(e.target.value)} className='custom-input' aria-label="Default select example"  style={FormStyle} >
      ...
      case 3:
        return (
          ...
          <div className='d-flex justify-content-between my-4'>
              ...
              <Form.Select onChange={(e)=>setGouvernorat(e.target.value)} aria-label="Default select example"  style={FormStyle} className="" >
              ...
              <Form.Label className='custom-label'></Form.Label>
              <Form.Select onChange={(e)=>setDelegation(e.target.value)} className='custom-input' aria-label="Default select example"  style={FormStyle} >
              ...
              <InputGroup className="custom-input">
                  <Form.Control onChange={(e)=>setPhone(e.target.value)} type="number" style={FormStyle}  placeholder="Numéro de téléphone" className="custom-input" aria-label="Amount (to the nearest dollar)" />
                </InputGroup>
          </div>
          </div>
        );
        ...
        <div className="col-lg-6 offset-lg-3">
          <form>
            ...
            {step < 3 ? (
              ...
              <button className='btnNext' type="submit" onClick={(e)=>handleAdd(e)}>
                Envoyer
              </button>
            )}
             {step > 1 && (
