...
const NavUser = () => {
   ...
   return (
      ...
      <Navbar bg="white" expand="lg " fixed="top" sticky="top" className='shadow-sm' style={{ height: '80px' }}>
      <Container fluid>
        <Image as={Link}  to ="/" style={{ width:'120px'}} src={logo} ></Image>
        {/* <Navbar.Brand src={logo} href="#">Navbar scroll</Navbar.Brand> */}
